#!/bin/bash
#SBATCH --job-name=osteo_mix025_random
...
#SBATCH --output=/home/dgogoana/osteophytes_project/logs/osteo_mix025_random_%j.out
#SBATCH --error=/home/dgogoana/osteophytes_project/logs/osteo_mix025_random_%j.err
