#!/bin/bash
#SBATCH --job-name=osteo_bin_smoke
...
#SBATCH --output=/home/dgogoana/osteophytes_project/logs/osteo_bin_smoke_%j.out
#SBATCH --error=/home/dgogoana/osteophytes_project/logs/osteo_bin_smoke_%j.err
