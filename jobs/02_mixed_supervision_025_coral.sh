#!/bin/bash
#SBATCH --job-name=osteo_mix025_coral
...
#SBATCH --output=/home/dgogoana/osteophytes_project/logs/osteo_mix025_coral_%j.out
#SBATCH --error=/home/dgogoana/osteophytes_project/logs/osteo_mix025_coral_%j.err
