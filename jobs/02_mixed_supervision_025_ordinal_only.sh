#!/bin/bash
#SBATCH --job-name=osteo_mix025_ord
...
#SBATCH --output=/home/dgogoana/osteophytes_project/logs/osteo_mix025_ord_%j.out
#SBATCH --error=/home/dgogoana/osteophytes_project/logs/osteo_mix025_ord_%j.err
