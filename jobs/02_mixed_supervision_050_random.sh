#!/bin/bash
#SBATCH --job-name=osteo_mix050_random
...
#SBATCH --output=/home/dgogoana/osteophytes_project/logs/osteo_mix050_random_%j.out
#SBATCH --error=/home/dgogoana/osteophytes_project/logs/osteo_mix050_random_%j.err
...
python scripts/07_train_mixed_supervision.py --supervision-mode mixed --strong-fraction 0.50 --weak-label-mode location_binary --strong-sampling-strategy random --model-head threshold_independent --loss-balance-mode proportional --selection-metric mean_spearman --epochs 10 --batch-size 32 --num-workers 2 --h5-path /scratch/dgogoana/osteophytes_project/data/all-for-hip-prediction-20260420-0.4mm-224x224.h5
