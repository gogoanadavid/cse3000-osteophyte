#!/bin/bash
#SBATCH --job-name=osteo_mix025_sev
...
#SBATCH --output=/home/dgogoana/osteophytes_project/logs/osteo_mix025_sev_%j.out
#SBATCH --error=/home/dgogoana/osteophytes_project/logs/osteo_mix025_sev_%j.err
