#!/bin/bash
#SBATCH --job-name=osteo_mix025_init_w01
...
#SBATCH --output=/home/dgogoana/osteophytes_project/logs/osteo_mix025_init_w01_%j.out
#SBATCH --error=/home/dgogoana/osteophytes_project/logs/osteo_mix025_init_w01_%j.err
