#!/bin/bash
#SBATCH --job-name=osteo_mix025_g2
...
#SBATCH --output=/home/dgogoana/osteophytes_project/logs/osteo_mix025_g2_%j.out
#SBATCH --error=/home/dgogoana/osteophytes_project/logs/osteo_mix025_g2_%j.err
